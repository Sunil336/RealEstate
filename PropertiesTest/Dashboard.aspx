<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="PropertiesTest.Dashboard" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="content-heading">
        ...
        <!-- END Language list-->
        Dashboard
               <small data-localize="dashboard">Welcome to Angle!</small>
    </div>
    <!-- START widgets box-->
    <div class="row">
                        ...
                        <div class="panel panel-default">
                           ...
                           <div class="list-group" data-height="180" data-scrollable="">
                              ...
                              <a class="list-group-item" href="#">
                                 <div class="media-box">
                                    <div class="pull-left">
                                       <img class="media-box-object img-circle thumb32" src="img/user/9.jpg" alt="Image">
                                    </div>
                                    <div class="media-box-body clearfix">
